  ...
  <div class="picker">
    <div v-if="selected" class="detail">
      ...
      <div class="meta">
        ...
        <div v-if="selected.sampleWallets.length" class="favorites">
    ...
    <div class="dock">
      ...
      >
        <div
          v-for="(suggestion, index) in windowItems"
        ...
        >
          <button
            ...
            :aria-label="suggestion.title.title"
...
const favorited = computed(() =>
  selected.value ? props.isFavorite(selected.value.title.id) : false
);
...
async function snapToIndex(index: number, behavior: ScrollBehavior) {
  ...
  const delta =
    itemRect.left + itemRect.width / 2 - (stripRect.left + stripRect.width / 2);
